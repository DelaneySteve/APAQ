"""
    Build and save a trained model given an airport
    dataset and a directory for storing the model.
"""
...
RF_model = MakeModel()
RF_model.train_fit(AUG_AIRPORTS_LOAD_PATH_FILE, MODEL_DUMP_PATH_DIR)
